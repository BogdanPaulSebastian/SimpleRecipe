...
fun Modifier.semiBorder(strokeWidth: Dp, color: Color, cornerRadiusDp: Dp, isTopSide: Boolean) = composed(
    factory = {
        ...
        Modifier.drawBehind {
            ...
            if (isTopSide) {
                ...
                drawLine(
                    color = color,
                    start = Offset(x = 0f, y = -height),
                    end = Offset(x = 0f, y = cornerRadius / 2),
                    strokeWidth = strokeWidthPx
                )
                ...
                drawLine(
                    color = color,
                    start = Offset(x = width, y = -height),
                    end = Offset(x = width, y = cornerRadius / 2),
                    strokeWidth = strokeWidthPx
                )
